...
export default function SubscriptionCreate() {
  ...
  async function handleSubmit(e) {
    ...
    const { error: err } = await supabase.from('subscriptions').insert({
      user_id: user.id, service_name: form.service_name, billing_day: day,
  ...
  return (
    <div className="max-w-lg">
      <div className="mb-6">
        ...
        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mt-1">Add Subscription</h2>
      </div>
